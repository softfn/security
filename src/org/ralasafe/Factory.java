...
public class Factory {
    private static Map privilegeManagers = new java.util.HashMap();
    private static Map roleManagers = new java.util.HashMap();
    private static Map userRoleManagers = new java.util.HashMap();
    ...
    private static Map userManagers = new java.util.HashMap();
    private static Map filterManagers = new java.util.HashMap();
    private static Map queryManagers = new java.util.HashMap();
    private static Map userCategoryManagers = new java.util.HashMap();
    private static Map businessDataManagers = new java.util.HashMap();
    private static Map entitlementManagers = new java.util.HashMap();
